...
class NetworkVisualizationDialog:
    ...
    def create_dialog(self):
        ...
        self.vis_window.resize(1200, 900)
        ...
        toolbar = NavigationToolbar2QT(canvas, self.vis_window)
        ...
        self.renderer = NetworkRenderer(self.G, self.icon_manager, fig, ax, canvas)
